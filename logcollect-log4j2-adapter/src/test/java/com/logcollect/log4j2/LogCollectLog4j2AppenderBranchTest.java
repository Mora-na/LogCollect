...
class LogCollectLog4j2AppenderBranchTest {
    ...
    void append_ignoreAndLoggerFilterBranches_covered() throws Exception {
        ...
        appender.append(mockEvent("m1", "com.test.A", Level.INFO, mdc, null));
        LogCollectIgnoreManager.clear();

        appender.append(mockEvent("m2", "com.skip.X", Level.INFO, mdc, null));
        appender.append(mockEvent("m3", "com.test.B", Level.DEBUG, mdc, null));
    ...
    private LogEvent mockEvent(String message, String logger, Level level, Map<String, String> mdc, Throwable t) {
        ...
        when(event.getThrown()).thenReturn(t);
    ...
    private LogCollectContext newContext(String traceId, LogCollectConfig config, LogCollectHandler handler) throws Exception {
        Method method = LogCollectLog4j2AppenderBranchTest.class.getDeclaredMethod("marker");
