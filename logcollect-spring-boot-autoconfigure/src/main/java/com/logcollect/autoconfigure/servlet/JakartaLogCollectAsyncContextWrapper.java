...
public class JakartaLogCollectAsyncContextWrapper implements AsyncContext {

    private final AsyncContext delegate;
    private final LogCollectContextSnapshot snapshot;

    public JakartaLogCollectAsyncContextWrapper(AsyncContext delegate, LogCollectContextSnapshot snapshot) {
