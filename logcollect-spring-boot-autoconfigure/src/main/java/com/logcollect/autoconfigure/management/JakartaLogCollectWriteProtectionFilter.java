...
/**
 * 无 Spring Security 时阻断管理端写操作（Jakarta 版本）。
 */
public class JakartaLogCollectWriteProtectionFilter implements Filter {
    private final LogCollectManagementAuditLogger auditLogger;

    public JakartaLogCollectWriteProtectionFilter(LogCollectManagementAuditLogger auditLogger) {
