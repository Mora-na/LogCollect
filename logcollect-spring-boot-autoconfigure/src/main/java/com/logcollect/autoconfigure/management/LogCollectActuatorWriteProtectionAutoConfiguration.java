...
public class LogCollectActuatorWriteProtectionAutoConfiguration {
    ...
    public FilterRegistrationBean<JavaxLogCollectWriteProtectionFilter> javaxLogCollectWriteProtectionFilter(
            @Autowired(required = false) LogCollectManagementAuditLogger auditLogger) {
        FilterRegistrationBean<JavaxLogCollectWriteProtectionFilter> registration =
                new FilterRegistrationBean<JavaxLogCollectWriteProtectionFilter>();
        registration.setFilter(new JavaxLogCollectWriteProtectionFilter(auditLogger));
